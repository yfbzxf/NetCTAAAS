...
import com.ct.entity.page.ServicePage;
...
public class ServiceController extends BaseController {
	...
	public String detailService(@RequestParam("service_id") int id, Model model) {
		Map<String, Object> serviceDetail=serviceDao.findServicedetailById(id);
		System.out.println(serviceDetail.get("SERVICE_ID"));
		System.out.println(serviceDetail.get("UNIX_HOST"));
		System.out.println(serviceDetail.get("ACCOUNT_ID"));
		System.out.println(serviceDetail.get("REAL_NAME"));
