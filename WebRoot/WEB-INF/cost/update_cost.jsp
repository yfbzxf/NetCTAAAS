		...
		<form action="updateCost.do" method="post" class="main_form">
			...
			<div class="input_info">
				<input type="text" name="name" class="width300"
					value="${cost.name }" /> <span class="required">*</span>
			...
			<div class="input_info fee_type">
				<input type="radio" name="cost_type" value="1" id="monthly"
					...
					<c:if test="${cost.cost_type==1 }">checked</c:if> /> <label
					for="monthly">包月</label> <input type="radio" name="cost_type"
					value="2" id="package" onclick="feeTypeChange(2);"
					<c:if test="${cost.cost_type==2 }">checked</c:if> /> <label
					for="package">套餐</label> <input type="radio" name="cost_type"
					value="3" id="timeBased" onclick="feeTypeChange(3);"
					<c:if test="${cost.cost_type==3 }">checked</c:if> /> <label
					for="timeBased">计时</label>
			</div>
			<div class="text_info clearfix">
				<span>基本时长：</span>
			</div>
			<div class="input_info">
				<input type="text" name="base_duration"
					value="${cost.base_duration }" class="width100" /> <span
			...
			<div class="input_info">
				<input type="text" name="base_cost" value="${cost.base_cost }"
			...
			<div class="input_info">
				<input type="text" name="unit_cost" value="${cost.unit_cost }"
