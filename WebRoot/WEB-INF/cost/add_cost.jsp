...
<body>
	...
	<div id="main">
		...
		<form action="addCost.do" method="post" class="main_form">
			...
			<div class="input_info">
				<input type="text" name="base_duration" class="width100" /> <span
			...
			<div class="input_info">
				<input type="text" name="base_cost" class="width100" /> <span
			...
			<div class="input_info">
				<input type="text" name="unit_cost" class="width100" /> <span
