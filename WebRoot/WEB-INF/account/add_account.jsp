...
<body>
	...
	<div id="main">
		...
		<form action="addAccount.do" method="post" class="main_form">
			...
			<div class="input_info">
				<input type="text" name="idcard_no"
					onblur="check_idcardno(this.value);" /> <span class="required">*</span>
			...
			<div class="input_info">
				<input type="text" name="login_name" /> <span class="required">*</span>
			...
			<div class="input_info">
				<input type="password" name="login_passwd" /> <span
					class="required">*</span>
				<div class="validate_msg_long">30长度以内的字母、数字和下划线的组合</div>
			</div>
			<div class="text_info clearfix">
			...
			<div class="input_info">
				<input type="text" class="width200" name="telephone" /> <span
					class="required">*</span>
			...
			<div id="optionalInfo" class="hide">
				...
				<div class="input_info">
					<input type="text" name="birthdate" readonly class="readonly"
						id="birthdate" />
				</div>
				<div class="text_info clearfix">
					<span>Email：</span>
				...
				<div class="input_info fee_type">
					<input type="radio" name="gender" value="1" checked="checked"
						...
						name="gender" value="0" id="male" /> <label for="male">男</label>
				</div>
				<div class="text_info clearfix">
					<span>通信地址：</span>
				</div>
