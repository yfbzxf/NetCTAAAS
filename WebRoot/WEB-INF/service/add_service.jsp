...
<body>
	...
	<div id="main">
		<!--保存操作的提示信息-->
		<div id="save_result_info" class="save_fail" id="operate_msg">保存失败！192.168.0.23服务器上已经开通过
			OS 账号 “mary”。</div>
		<form action="addService.do" method="post" id="form1"
			class="main_form">
			<!--内容项-->
			...
			<div class="input_info">
				<input type="text" class="width180" id="idcard_no" /> <input
					type="button" value="查询账务账号" class="btn_search_large"
					onclick="find_account();" /> <span class="required">*</span>
			...
			<div class="input_info">
				<input type="hidden" name="account_id" id="account_id" /> <input
					type="text" readonly="readonly" class="readonly" id="login_name" />
			...
			<div class="input_info">
				<input type="text" name="unix_host" /> <span class="required">*</span>
			...
			<div class="input_info">
				<input type="text" name="os_username" /> <span class="required">*</span>
